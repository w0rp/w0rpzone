...
$(function() {
    ...
    function _settings_notify_impl(message, error) {
    ...
    function settings_notify(message) {
        _settings_notify_impl(message, false);
    }

    function settings_notify_error(message) {
        _settings_notify_impl(message, true);
    }
    ...
    && !$.cookie("timezone")) {
        ...
        .done(function() {
            settings_notify(
                "Your timezone has been automatically guessed."
            );
        })
        .fail(function() {
            settings_notify_error(
                "I failed to guess your timezone here."
            );
