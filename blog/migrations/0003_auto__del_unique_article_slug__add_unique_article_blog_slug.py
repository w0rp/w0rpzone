...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Article', fields ['blog', 'slug']
        db.create_unique('blog_article', ['blog_id', 'slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Article', fields ['blog', 'slug']
        db.delete_unique('blog_article', ['blog_id', 'slug'])
    ...
    models = {
        ...
        'blog.article': {
            'Meta': {'unique_together': "(('blog', 'slug'),)", 'object_name': 'Article'},
        ...
        'blog.blogauthor': {
            'Meta': {'unique_together': "(('blog', 'author'),)", 'object_name': 'BlogAuthor'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'blog': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['blog.Blog']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
