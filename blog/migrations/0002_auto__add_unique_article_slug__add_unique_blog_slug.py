...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Blog', fields ['slug']
        db.create_unique('blog_blog', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Blog', fields ['slug']
        db.delete_unique('blog_blog', ['slug'])
    ...
    models = {
        ...
        'blog.article': {
            ...
            'creation_date': ('django.db.models.fields.DateField', [], {'blank': 'True', 'auto_now_add': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'blog.blogauthor': {
            'Meta': {'object_name': 'BlogAuthor', 'unique_together': "(('blog', 'author'),)"},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'blog': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['blog.Blog']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
