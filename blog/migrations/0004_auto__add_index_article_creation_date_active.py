...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Article', fields ['creation_date', 'active']
        db.create_index('blog_article', ['creation_date', 'active'])


    def backwards(self, orm):
        # Removing index on 'Article', fields ['creation_date', 'active']
        db.delete_index('blog_article', ['creation_date', 'active'])
    ...
    models = {
        ...
        'blog.article': {
            'Meta': {'ordering': "['-creation_date']", 'object_name': 'Article', 'index_together': "(('creation_date', 'active'),)"},
